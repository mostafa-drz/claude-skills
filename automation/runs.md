...
| 2026-06-06 | desktop/meeting-prep | https://github.com/mostafa-drz/claude-skills/pull/6 | open | | Re-run: PR #6 still open. No new topic built (would be duplicate). Added docs-cache/2026-06-06.md; no upstream changes vs 2026-05-22. support.claude.com 403s persist. |
