...
| 2026-05-19 | desktop/weekly-review | https://github.com/mostafa-drz/claude-skills/pull/10 | open | | First run; two support.claude.com docs URLs returned 403 (auth-walled); platform docs URL fetched successfully |
