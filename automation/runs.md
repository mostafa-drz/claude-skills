...
| 2026-05-30 | desktop/focus-planner | <!-- pr_url --> | open | | First run — Phase A skipped (no prior rows). Two of three upstream doc URLs returned 403; platform docs available. |
